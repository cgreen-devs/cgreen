...
NOTE: If you use the runner, as described in <<runner>>, and thus link your tests into a shared library, don't forget to link it with the same C++ library that was used to create the `cgreen-runner`.
