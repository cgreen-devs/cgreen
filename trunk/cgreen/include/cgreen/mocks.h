...
#define always_expect(f, ...) _always_expect(#f, __FILE__, __LINE__, (CgreenConstraint *)__VA_ARGS__ +0, (CgreenConstraint *)0)
...
#define mock(f, r, ...) _will_return(#f, (intptr_t)r); _expect(#f, __FILE__, __LINE__, (CgreenConstraint *)__VA_ARGS__ +0, (CgreenConstraint *)0)
#define always_mock(f, r, ...) _always_return(#f, (intptr_t)r); _always_expect(#f, __FILE__, __LINE__, (CgreenConstraint *)__VA_ARGS__ +0, (CgreenConstraint *)0)
