...
Ensure(ConstraintPrintout, failure_message_for_is_null) {
    int i;
    int *pointer = &i;
    assert_that(pointer, is_null);
}

Ensure(ConstraintPrintout, failure_message_for_is_non_null) {
    int *pointer = NULL;
    assert_that(pointer, is_non_null);
}

Ensure(ConstraintPrintout, failure_message_for_is_equal_to) {
    int fourty_five = 45, thirty_three = 33;
    assert_that(fourty_five, is_equal_to(thirty_three));
}

Ensure(ConstraintPrintout, failure_message_for_is_not_equal_to) {
    int should_not_be_fourty_five = 45, forty_five = 45;
    assert_that(should_not_be_fourty_five, is_not_equal_to(forty_five));
}

Ensure(ConstraintPrintout, failure_message_for_is_greater_than) {
    int fourty_five = 45, thirty_three = 33;
    assert_that(thirty_three, is_greater_than(fourty_five));
}

Ensure(ConstraintPrintout, failure_message_for_is_less_than) {
    int fourty_five = 45, thirty_three = 33;
    assert_that(fourty_five, is_less_than(thirty_three));
}

Ensure(ConstraintPrintout, failure_message_for_is_equal_to_contents_of) {
    int fourty_five[45] = {45, 44, 43}, thirty_three[33] = {45, 44, 33};
    assert_that(thirty_three, is_equal_to_contents_of(fourty_five, 55));
}

Ensure(ConstraintPrintout, failure_message_for_is_not_equal_to_contents_of) {
...
Ensure(ConstraintPrintout, failure_message_for_is_equal_to_string) {
...
Ensure(ConstraintPrintout, failure_message_for_is_not_equal_to_string) {
...
Ensure(ConstraintPrintout, failure_message_for_contains_string) {
...
Ensure(ConstraintPrintout, failure_message_for_does_not_contain_string) {
...
Ensure(ConstraintPrintout, failure_message_for_begins_with_string) {
...
Ensure(ConstraintPrintout, failure_message_for_assert_that) {
    assert_that(0 == 1);
}
...
Ensure(ConstraintPrintout, warns_for_always_followed_by_expectation) {
...
TestSuite *all_constraints_tests() {
    ...
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_equal_to);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_not_equal_to);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_greater_than);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_less_than);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_equal_to_contents_of);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_not_equal_to_contents_of);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_equal_to_string);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_is_not_equal_to_string);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_contains_string);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_does_not_contain_string);
    add_test_with_context(suite, ConstraintPrintout, failure_message_for_begins_with_string);
