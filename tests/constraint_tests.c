...
static bool compare_integer_constraint(CgreenConstraint *c, int x) {
...
static bool compare_pointer_constraint(CgreenConstraint *c, void *x) {
...
static bool compare_string_constraint(CgreenConstraint *c, const char *x) {
...
static bool compare_double_constraint(CgreenConstraint *c, double x) {
